...
REWARD_FALLBACKS = {
 'SWGAJA2BKK':[['mana','x200000'],['yellow','x1']], 'SWCJOAAAKR26':[['yellow','x1']],
 '2SWCTORONTOTHE6IX':[['energy','x100'],['yellow','x1']], 'APAC1K0UB4NGK0K':[['energy','x100'],['yellow','x1']],
 '2SOREIKENIPPON6':[['mana','x200000'],['yellow','x1']], 'AUGSW2026V7N':[['energy','x100'],['red','x3']],
 'LAST4PUNCHIN':[['mana','x200000'],['yellow','x1']], 'SWXFRIEREN2026':[['energy','x100'],['mana','x300000'],['yellow','x3']],
