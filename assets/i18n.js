...
function normalizeBrand(){
 ...
 document.querySelectorAll('.myst-y').forEach(x=>{x.textContent='y';x.style.fontSize='.76em';x.style.display='inline-block';x.style.lineHeight='1';x.style.transform='translateY(.02em)'});
