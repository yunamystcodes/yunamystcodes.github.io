...
function apply(en){
  ...
  setTimeout(()=>{translate(en);closeLanguageMenu(sw);community(en);fixFAQ(en);},0);
  setTimeout(()=>{translate(en);closeLanguageMenu(sw);community(en);fixFAQ(en);},100);
}
